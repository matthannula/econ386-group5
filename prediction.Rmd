...
All 5 members of our group uploaded his or her own code in order to select the model that gave the best prediction on the test data. We used the resample and list functions in order to compare the models side by side in order to chose the model with the highest accuracy out-of-sample (on the testing data). 
