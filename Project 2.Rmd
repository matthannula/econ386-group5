...
metric <- "Accuracy"
```
Splits dataset into 20 different parts for crossvalidation. Sets seet at 5 (group number = 5).
...
```
Creates a random forest model and sets seet at 5 (group number = 5). Produces both a prediction and the confusion matrix for the given prediction of the test data.
